...
public class HighestRatedMoviesDetailActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_highest_rated_movies_detail);

        // No need for this activity if orientation is landscape :
        if(getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE){
            this.finish();
        }
        context = HighestRatedMoviesDetailActivity.this;
            ...
            View.OnClickListener onClickListener = new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(currentTheMovieDBObjectSelected.getTrailerLink() == null || currentTheMovieDBObjectSelected.getTrailerLink().equals("")){
                        ...
                        if (toast == null) {
                            toast = Toast.makeText(HighestRatedMoviesDetailActivity.this, "Downloading Trailer, Try Again Later", Toast.LENGTH_SHORT);
                        } else {
                            toast.cancel();
                            toast = Toast.makeText(HighestRatedMoviesDetailActivity.this, "Downloading Trailer, Try Again Later", Toast.LENGTH_SHORT);
                        }
    ...
    private void loadBackdropImage(){
        ...
        Picasso.with(HighestRatedMoviesDetailActivity.this).load(currentTheMovieDBObjectSelected.getBackdropPath()).into(imageView);
    }
    ...
    public void backClicked(View v){
        HighestRatedMoviesDetailActivity.this.onBackPressed();
    }
    ...
    public void favClicked(View v){
        ...
        if(isShownFav) {
            ...
            DeleteFavourite deleteFavourite = new DeleteFavourite(HighestRatedMoviesDetailActivity
                    .this);
            ...
            // Showing Save Toast :
            if (toast == null) {
                toast = Toast.makeText(HighestRatedMoviesDetailActivity.this, "Favourite Saved", Toast.LENGTH_SHORT);
            } else {
                toast.cancel();
                toast = Toast.makeText(HighestRatedMoviesDetailActivity.this, "Favourite Saved", Toast.LENGTH_SHORT);
            }
            ...
            SaveFavourite saveFavourite = new SaveFavourite(HighestRatedMoviesDetailActivity.this);

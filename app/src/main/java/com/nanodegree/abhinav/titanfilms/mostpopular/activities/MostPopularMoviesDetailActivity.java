...
public class MostPopularMoviesDetailActivity extends Activity {
    ...
    /**
     * Bitmap of Poster Image
     */
    private Bitmap bitmapPosterImage;

    /**
     * Bitmap of backdrop image
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_most_popular_movies_detail);

        // No need for this activity if orientation is landscape :
        if(getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE){
            this.finish();
        }
        context = MostPopularMoviesDetailActivity.this;
        TitanFilmsApplication titanFilmsApplication = (TitanFilmsApplication) getApplication();
        ...
        // Bitmap Image for poster :
        bitmapPosterImage = ((BitmapDrawable)im.getDrawable()).getBitmap();
        ...
        // Current Object :
        currentTheMovieDBObjectSelected = applicationSavedData.getCurrentSelectedForMostPopular();
            ...
            View.OnClickListener onClickListener = new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(currentTheMovieDBObjectSelected.getTrailerLink() == null || currentTheMovieDBObjectSelected.getTrailerLink().equals("")){
                        ...
                        if (toast == null) {
                            toast = Toast.makeText(MostPopularMoviesDetailActivity.this, "Downloading Trailer, Try Again Later", Toast.LENGTH_SHORT);
                        } else {
                            toast.cancel();
                            toast = Toast.makeText(MostPopularMoviesDetailActivity.this, "Downloading Trailer, Try Again Later", Toast.LENGTH_SHORT);
                        }
    ...
    private void loadBackdropImage(){
        ...
        Picasso.with(MostPopularMoviesDetailActivity.this).load(currentTheMovieDBObjectSelected.getBackdropPath()).into(imageView);
    }
    ...
    public void backClicked(View v){
        MostPopularMoviesDetailActivity.this.onBackPressed();
    }
    ...
    public void favClicked(View v){
        ...
        ImageView imbackdrop  = (ImageView)findViewById(R.id.backdrop_image_view);
        bitmapBackdropImage = ((BitmapDrawable)imbackdrop.getDrawable()).getBitmap();
        ...
        if(isShownFav) {
            ...
            DeleteFavourite deleteFavourite = new DeleteFavourite(MostPopularMoviesDetailActivity.this);
            ...
            // Showing Save Toast :
            if (toast == null) {
                toast = Toast.makeText(MostPopularMoviesDetailActivity.this, "Favourite Saved", Toast.LENGTH_SHORT);
            } else {
                toast.cancel();
                toast = Toast.makeText(MostPopularMoviesDetailActivity.this, "Favourite Saved", Toast.LENGTH_SHORT);
            }
            ...
            SaveFavourite saveFavourite = new SaveFavourite(MostPopularMoviesDetailActivity.this);

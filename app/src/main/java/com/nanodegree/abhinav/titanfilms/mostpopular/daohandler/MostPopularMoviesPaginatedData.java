 ...
 */
public class MostPopularMoviesPaginatedData {
    ...
    public MostPopularMoviesPaginatedData(Context context){
    ...
    private class JSONDataFetch extends AsyncTask<String,String,JSONArray> {
        ...
        protected void onPostExecute(JSONArray result) {
            ...
            mostPopularMoviesDataFetchHandler.dataReady(theMovieDBObjectArrayList);
    ...
    public void resultIsNull(){
        ...
        alertDialog.setButton2("Settings", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                MostPopularMoviesGridActivity.loadedOnce = true;
                alertDialog.hide();
            }
        });

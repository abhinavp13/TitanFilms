package com.nanodegree.abhinav.titanfilms.favourite.adapter;
...
import com.nanodegree.abhinav.titanfilms.favourite.activities.FavouriteMoviesDetailActivity;
import com.nanodegree.abhinav.titanfilms.favourite.daohandler.FavouriteMoviesDataFetchHandler;
import com.nanodegree.abhinav.titanfilms.favourite.fragments.TheFavouriteDetailsFragment;
...
/**
 * This class is FavouriteGridView Adapter.
 *
 * Created by Abhinav Puri
 */
public class FavouriteMoviesGridAdapter extends BaseAdapter {

    /**
     * Context for FavouriteMovies Activity.
     */
    private Context context;

    /**
     * Layout Inflater from FavouriteMovies Activity.
     */
     ...
     */
    public FavouriteMoviesGridAdapter(Context context, LayoutInflater layoutInflater, ArrayList<TheMovieDBObject> theMovieDBObjectArrayList){
     ...
     *
     * @param favouriteMoviesDataFetchHandler
     */
     ...
     * @return list of favourite movies data.
     */
    public ArrayList<TheMovieDBObject> getTheFavouriteMoviesData(){
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(!isDummyData) {
            ((Activity)context).findViewById(R.id.nothing_to_display).setVisibility(View.GONE);
            ...
            holder.moviePoster.setImageBitmap(theMovieDBObjectArrayList.get(position).getBitmapPosterImage());
            ...
            if(isFirstTime && applicationSavedData.getCurrentSelectedForFavourite()==null){
                applicationSavedData.setCurrentSelectedForFavourite(theMovieDBObjectArrayList.get(position));
            } else if(isFirstTime && applicationSavedData.getCurrentSelectedForFavourite()!=null) {
                if (applicationSavedData.getCurrentSelectedForFavourite().getTitle() == null) {
                    applicationSavedData.setCurrentSelectedForFavourite(theMovieDBObjectArrayList.get(position));
                }
            }
            ...
            if(isFirstTime) {
                if (context.getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE &&
                        ((Activity) context).getFragmentManager().findFragmentById(R.id.favourite_fragment_2) != null) {
                    TheFavouriteDetailsFragment fragment = (TheFavouriteDetailsFragment) ((Activity) context).getFragmentManager().findFragmentById(R.id.favourite_fragment_2);
                    fragment.refresh(true);
                }
                isFirstTime = false;
            }

            if(applicationSavedData.getCurrentSelectedForFavourite().equals(theMovieDBObjectArrayList.get(position))){
            ...
            convertView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(context.getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE &&
                        ...
                        Intent intent = new Intent(context, FavouriteMoviesDetailActivity.class);
            ...
            ((Activity)context).findViewById(R.id.nothing_to_display).setVisibility(View.VISIBLE);
    ...
    public void addMoreItemsClearPrevious(ArrayList<TheMovieDBObject> theMovieDBObjects, boolean isDummy){
        ...
        theMovieDBObjectArrayList.addAll(theMovieDBObjects);
        notifyDataSetChanged();
    }

 ...
 */
public class TheFavouriteDetailsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.favourite_movies_detail_fragment,container,false);
        refresh(true);
        return rootView;
    }

    /**
     * Does Initiliztion based on refresh type.
     *
     * @param hardRefresh
     */
            ...
            View.OnClickListener onClickListener = new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(currentTheMovieDBObjectSelected.getTrailerLink().equals("") || currentTheMovieDBObjectSelected.getTrailerLink()==null){
                        ...
                        if(getActivity() != null) {
                            if (toast == null) {
                                toast = Toast.makeText(getActivity(), "Fetching Trailer, Try Again Later", Toast.LENGTH_SHORT);
                            } else {
                                toast.cancel();
                                toast = Toast.makeText(getActivity(), "Fetching Trailer, Try Again Later", Toast.LENGTH_SHORT);
                            }

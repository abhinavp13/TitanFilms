...
public class SearchMovieDetail extends Activity {
...
//        }
        ...
        context = SearchMovieDetail.this;
        ...
        // Current Object :
        currentTheMovieDBObjectSelected = applicationSavedData.getCurrentSelectedForSearch();
            ...
            View.OnClickListener onClickListener = new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(currentTheMovieDBObjectSelected.getTrailerLink() == null || currentTheMovieDBObjectSelected.getTrailerLink().equals("")){
                        ...
                        if (toast == null) {
                            toast = Toast.makeText(SearchMovieDetail.this, "Downloading Trailer, Try Again Later", Toast.LENGTH_SHORT);
                        } else {
                            toast.cancel();
                            toast = Toast.makeText(SearchMovieDetail.this, "Downloading Trailer, Try Again Later", Toast.LENGTH_SHORT);
                        }
    ...
    private void loadBackdropImage(){
        ...
        Picasso.with(SearchMovieDetail.this).load(currentTheMovieDBObjectSelected.getBackdropPath()).into(imageView);
    }
    ...
    public void backClicked(View v){
        SearchMovieDetail.this.onBackPressed();
    }
